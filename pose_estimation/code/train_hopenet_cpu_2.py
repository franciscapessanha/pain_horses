...
if __name__ == '__main__':
    ...
    if args.dataset == 'Pose_300W_LP':
        ...
        pose_dataset = datasets.Equines(args.data_dir, args.filename_list, transformations)
    ...
    for epoch in range(num_epochs):
        for i, (images, labels, cont_labels, name) in enumerate(train_loader):
            ...
            print('label yaw: ', np.shape(label_yaw))
        ...
        if epoch % 1 == 0 and epoch < num_epochs:
            print( 'Taking snapshot...', torch.save(model.state_dict(),'output/snapshots/' + args.output_string + '_epoch_'+ str(epoch+1) + '.pkl'))
